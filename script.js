var audio = $("#soundDesignDemo")[0];
audio.volume = 0.5;
audio.currentTime = 10;
document.getElementById("soundDesign").addEventListener("mouseenter", function() {
    audio.play();
});
document.getElementById("soundDesign").addEventListener("mouseleave", function() {
    audio.pause();
});
